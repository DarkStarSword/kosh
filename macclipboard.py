...
def copy_text_simple(blob):
  ...
  clipboard.declareTypes_owner_([AppKit.NSStringPboardType], None)
  # TODO: Defer setting data until clipboard request
  clipboard.setData_forType_(data, AppKit.NSStringPboardType)
